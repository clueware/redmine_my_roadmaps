...
Please note that the main development branch (master) is for the Redmine 1.x. The Redmine_2.0 branch track Redmine 2.0.x compatibility, Redmine_2.1 branch is suitable for both Redmine 2.1 and 2.2 versions and Redmine_2.3 for 2.3, 2.4 and 2.6 versions.

A release for Redmine 3.0 is still pending.

As usual, each version is available on Redmine plugin catalog in both flavors (Redmine 1 and Redmine 2): http://www.redmine.org/plugins/my_roadmaps
